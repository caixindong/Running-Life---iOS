        ...
        [self.manager getKcalWithWeight:65
                               ...
                               complete:^(id arr) {
                                   ...
                                   dispatch_async(dispatch_get_main_queue(), ^{
                                       [self drawRecord];
                                       self.runKcalArr = [self.recordManager getKcalDataWithMonth:month withYear:year withWeight:65];
    ...
    [self.manager getKcalWithWeight:65
                              ...
                              month:comp.month
                                day:1 complete:^(id arr) {
                                    ...
                                    dispatch_async(dispatch_get_main_queue(), ^{
                                        [self drawRecord];
                                        self.runKcalArr = [self.recordManager getKcalDataWithMonth:comp.month withYear:comp.year withWeight:65];
                                        [self drawRunRecord];
                                        StrongObj(calendarWeak)
                                        calendarWeakStrong.specialDataArr = self.runKcalArr;
                                    });
